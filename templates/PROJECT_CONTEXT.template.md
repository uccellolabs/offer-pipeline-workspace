...
> Utilisé par `/offer-idea-finder` pour filtrer les opportunités business.
...
> Utilisé par `/offer-pitch-deck` (HTML) et `/offer-study-website`.
...
> Une fois rempli, lance `/offer-idea-finder` ou `/offer-cadrage` pour démarrer.